...
export class MovieService {
  private readonly apiUrl = './assets/movies-list.json';

  constructor(private http: HttpClient) { }

  // getMoviesListd(): movieObject[] {
  //   return [
  //     {
  //       adult: false,
  ...
  updateMoviesList(movies: movieObject[]): Observable<movieObject[]> {
    return this.http.post<movieObject[]>(this.apiUrl, movies);
  }
